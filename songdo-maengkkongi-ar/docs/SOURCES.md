...
- 맹꽁이: 처음 사용했던 [국립환경과학원 생태도감 수록 울음의 Vimeo 원본 플레이어](https://vimeo.com/40431293)를 관찰 화면과 마지막 소리 특징 문제에서 연결합니다. 영상 속 제목이 종을 알려 주므로 마지막 문제는 종 맞히기가 아니라 울음 특징을 고르는 문제로 구성했습니다. 영상·음원을 추출하거나 재배포하지 않습니다.
- 옴개구리: [Vimeo 40431369](https://vimeo.com/40431369)

맹꽁이와 옴개구리는 국립환경과학원 도감 수록 소리를 소개하는 원본 Vimeo 플레이어를 이용자 클릭 후 연결합니다. 해당 음원 파일은 추출해 배포하지 않습니다. 외부 네트워크 상태나 원본 공개 상태에 따라 재생이 달라질 수 있습니다. 사진·영상은 이 플레이어에 전달하지 않습니다.
